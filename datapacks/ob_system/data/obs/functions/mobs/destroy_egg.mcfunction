...
kill @e[type=item,nbt={Item:{id:"minecraft:sniffer_spawn_egg"}}]
kill @e[type=item,nbt={Item:{id:"minecraft:rabbit_spawn_egg"}}]
kill @e[type=item,nbt={Item:{id:"minecraft:horse_spawn_egg"}}]
kill @e[type=item,nbt={Item:{id:"minecraft:villager_spawn_egg"}}]
kill @e[type=item,nbt={Item:{id:"minecraft:allay_spawn_egg"}}]
kill @e[type=item,nbt={Item:{id:"minecraft:bee_spawn_egg"}}]
kill @e[type=item,nbt={Item:{id:"minecraft:panda_spawn_egg"}}]
kill @e[type=item,nbt={Item:{id:"minecraft:fox_spawn_egg"}}]